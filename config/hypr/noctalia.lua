...
local primary = "rgb(babbf1)"
local surface = "rgb(303446)"
local on_surface = "rgb(c6d0f5)"
local secondary = "rgb(8caaee)"
local on_secondary = "rgb(303446)"
local error = "rgb(e78284)"
local on_error = "rgb(303446)"
